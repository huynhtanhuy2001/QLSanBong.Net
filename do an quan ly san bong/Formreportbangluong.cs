...
{
    public partial class Formreportbangluong : Form
    {
        ...
        private void Formreportbangluong_Load(object sender, EventArgs e)
        {
            Model1 md = new Model1();
            //lấy ds hoadon
            List<BANG_LUONG> HD = md.BANG_LUONG.ToList();
            this.reportViewer1.RefreshReport();
            this.reportViewer1.LocalReport.ReportPath = "./ReportBANGLUONG.rdlc";
            ReportDataSource reportDataSource = new ReportDataSource("BANGLUONG", HD);
        ...
        private void Formreportbangluong_FormClosing(object sender, FormClosingEventArgs e)
        {
